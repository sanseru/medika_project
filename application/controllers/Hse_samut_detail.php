...
class Hse_samut_detail extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('Hse_samut_detail');
    ...
    {
        $this->template->load('template','hse_samut_detail/hse_sasaran_mutu_detail_list');
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Hse_samut_detail->json();
    }

    public function read($id) 
    {
        $row = $this->Hse_samut_detail->get_by_id($id);
        if ($row) {
            $data = array(
		'id' => $row->id,
		...
		'keterangan' => $row->keterangan,
            ...
            $this->template->load('template','hse_samut_detail/hse_sasaran_mutu_detail_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('hse_samut_detail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('hse_samut_detail/create_action'),
	    'id' => set_value('id'),
        ...
        $this->template->load('template','hse_samut_detail/hse_sasaran_mutu_detail_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Hse_samut_detail->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('hse_samut_detail/update_action'),
    ...
    public function update_action() 
    {
		...
		'keterangan' => $this->input->post('keterangan',TRUE),
            ...
            $this->Hse_samut_detail->update($this->input->post('id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Hse_samut_detail->delete($id);
	...
	foreach ($this->Hse_samut_detail->get_all() as $data) {
            $kolombody = 0;
...
/* End of file Hse_samut_detail.php */
/* Location: ./application/controllers/Hse_samut_detail.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2018-06-08 03:45:33 */
/* http://harviacode.com */